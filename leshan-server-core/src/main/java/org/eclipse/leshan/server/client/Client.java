...
public class Client implements Serializable {
    ...
    public String toString() {
        return String
                .format("Client [registrationDate=%s, address=%s, port=%s, registrationEndpoint=%s, lifeTimeInSec=%s, smsNumber=%s, lwM2mVersion=%s, bindingMode=%s, endpoint=%s, registrationId=%s, objectLinks=%s, lastUpdate=%s, firstUpdate=%s]",
    ...
    public static class Builder {
        ...
        public Builder firstUpdate(boolean firstUpdate) {
            this.firstUpdate = firstUpdate;
            return this;
        }
        ...
        public Client build() {
            return new Client(Builder.this.registrationId, Builder.this.endpoint, Builder.this.address,
                    ...
                    this.lastUpdate, this.additionalRegistrationAttributes, this.firstUpdate);
        }
